...
**Gate final E63** : exécution réelle minimale = FAITE et verte (mp4 synthétique, sans close-day). Restent au gate transversal : run `--with-close-day` complet (WhisperX GPU) et run contre la vraie vidéo 5 min ci-dessus une fois filmée.
