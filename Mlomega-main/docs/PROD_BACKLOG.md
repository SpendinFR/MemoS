...
> - **Writers V13 durcis** : toute FK proposée par le LLM est vérifiée dans sa table et, pour un turn, dans la conversation. Les 16 moteurs par épisode sont maintenant checkpoints atomiquement par hash de prompt ; une erreur au moteur N ne rejoue plus 1..N-1. **55 tests ciblés verts**, dont FK négative et reprise exacte. Le volume actuel (**19 épisodes × 16 = 304 appels**) reste à mesurer/arbitrer sans supprimer de passe ; gate complet toujours ouvert.
